...
<div class="text-right">
  <a href="{{route('post.show_applicant',$ids=[['id'=>$posts->id],['id'=>$items->id]])}}"><button class="btn btn-success">複写新規</button></a>
</div>
...
<input class="form-control" type="hidden" name="application_status" value="1">
                ...
                <div class="form-group col-1 mb-2">
                    ...
                    <input class="form-control" type="text"  name="application_day" value="{{ date('Ymd') }}" style="width: 100px";>
                </div>
                ...
                <div class="form-group col-2 mb-2">
                    ...
                    <input class="form-control" type="date" name="delivery_hope_day" style="width: 125px" value="{{old('delivery_hope_day')}}">
               </div>
        ...
        <div id="table-block" class="center mb-2">
            ...
            <table id="item_table" class="table table-bordered table table-hover">
              ...
              <tbody>
                <tr class="item">
                  <td>
                      <input class="form-control" name="consumables_equipment_id[0]" value="{{old('')}}">
                  </td>
                  <td>
                      <input type="text" class="form-control"  name="product_name[0]" value="{{$ids->items->product_name}}">
                  </td>
                  <td>
                  <input type="text" class="form-control text-right" size="5" name="unit_purchase_price[0]" pattern="^[0-9]+$" value="{{$posts->unit_purchase_price}}">
                  </td>
                  <td>
                  <input type="text" class="form-control text-right" size="3" name="purchase_quantities[0]" pattern="^[0-9]+$"required value="{{$posts->purchase_quantities}}">
                  </td>
                  <td>
                    <input type="text" class="form-control text-right" size="3" name="{{$posts->units}}">
                  </td>
                  <td>
                      <input class="form-control" name="account_id[0]" value="{{old('accound_id')}}">
                  </td>
